...
const styles = StyleSheet.create({
  ...
  footer:           { position: 'absolute', left: 0, right: 0, bottom: 0, paddingHorizontal: 28, paddingTop: 14, paddingBottom: Platform.OS === 'ios' ? 52 : 36, backgroundColor: 'rgba(10,10,10,0.96)' },
