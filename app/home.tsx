...
export default function HomeScreen() {
  ...
  const greeting =
    hour < 12 ? 'good morning,' : hour < 17 ? 'good afternoon,' : 'good night,';
        ...
        <View style={styles.heroWrap}>
          ...
          >
            ...
            <View style={styles.heroPad}>
              ...
              <TouchableOpacity
                onPress={() => router.push('/sekret' as any)}
            ...
            {[
              ...
              >
                <View
                  style={[
                    styles.moodCircle,
                    mood === m.id && styles.moodCircleActive,
                  ]}
                >
