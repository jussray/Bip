...
const TEEN_SHORTCUTS = [
  { label: 'Write It Out', emoji: '✏️', route: '/teen/bips'     },
  { label: 'Voice Bip',   emoji: '🎙️', route: '/teen/voicebip' },
  { label: 'Calm Me',     emoji: '☁️', route: null              },
  { label: 'Circle',      emoji: '👥', route: '/teen/circle'    },
] as const;
...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    backgroundColor: '#111827', borderRadius: 20, padding: 18, marginBottom: 14, borderWidth: 1,
  },
