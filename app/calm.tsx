    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.heroWrap}>
          <ImageBackground source={IMAGES.roomBgDark} style={styles.heroBg} resizeMode="cover">
            ...
            <View style={styles.heroContent}>
              ...
              <Text style={styles.heroTitle}>Se'kret Calm 💜</Text>
              <Text style={styles.heroMini}>your safe place.</Text>
            </View>
          </ImageBackground>
        </View>
        ...
        <View style={[styles.card, { overflow: 'hidden' }]}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.cardTitle}>Take a deep breath, {charName}. 💜</Text>
            <Text style={styles.cardSub}>you made it through today. that matters.</Text>
          </View>
        ...
        <View style={[styles.card, { flexDirection: 'column' }]}>
          <Text style={[styles.cardTitle, { marginBottom: 12 }]}>How are you feeling right now?</Text>
        ...
        <View style={[styles.card, { flexDirection: 'column', overflow: 'hidden', borderColor: 'rgba(168,85,247,0.25)' }]}>
          ...
          <Text style={styles.breathSub}>a simple way to calm your mind and body</Text>
          <View style={styles.breathBox}>
            ...
            <Text style={[styles.breathLabel, { top: 4 }]}>breathe in 4</Text>
            <Text style={[styles.breathLabel, { bottom: 4, color: C.pinkHot }]}>breathe out 4</Text>
            <Text style={[styles.breathLabel, { left: 0 }]}>hold 4</Text>
            <Text style={[styles.breathLabel, { right: 0 }]}>hold 4</Text>
          </View>
          <TouchableOpacity onPress={() => router.push('/mindReset')} style={styles.gradBtn}>
            <LinearGradient colors={['#7c3aed', '#ec4899']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.gradBtnInner}>
              <Text style={styles.gradBtnText}>⏸ Start Breathing</Text>
            </LinearGradient>
          </TouchableOpacity>
        </View>
        ...
        <View style={{ marginHorizontal: 16, marginBottom: 12 }}>
          <Text style={[styles.cardTitle, { marginBottom: 10 }]}>Calm Tools ✦</Text>
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            <View style={{ flexDirection: 'row', gap: 10 }}>
              {[
        ...
        <View style={[styles.card, { flexDirection: 'column' }]}>
          <View style={styles.rowBetween}>
            <Text style={styles.cardTitle}>Calm Playlist ✦</Text>
            <Text style={styles.seeAll}>see all</Text>
          </View>
          <Text style={[styles.cardSub, { marginBottom: 12 }]}>music + sounds to relax</Text>
          {sounds.map((s, i) => (
        ...
        <TouchableOpacity onPress={() => router.push('/comfort')} style={styles.gradBtn}>
          <LinearGradient colors={['rgba(124,58,237,0.4)', 'rgba(236,72,153,0.4)']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={[styles.gradBtnInner, { borderWidth: 1, borderColor: 'rgba(168,85,247,0.3)' }]}>
            <Text style={styles.gradBtnText}>🚨 Open Comfort Mode</Text>
          </LinearGradient>
        </TouchableOpacity>
