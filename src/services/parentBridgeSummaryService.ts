...
export async function fetchParentBridgeSummaryInbox(
  ...
  if (requestError) {
    return { ok: false, code: 'server_error', message: requestError.message };
  }
