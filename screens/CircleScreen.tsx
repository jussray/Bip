...
const MOCK_CREW: CrewCirclePost[] = [
  { id: 1, user_id: 'u2', nickname: 'Star 💜', avatar_emoji: '💜', text: "crew check-in: what\'s one thing we're each holding right now?", post_mood: null, media_kind: null, reactions: { felt: 3, comfort: 5, proud: 1, stay: 2 }, created_at: new Date().toISOString() },
];
