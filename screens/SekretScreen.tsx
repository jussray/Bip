...
//   • Per-character copy: Star, Rylane, Cloud, Night each have distinct
...
const SEKRET_PROFILES: Record<string, any> = {
  soft:   { name: 'Star',        emoji: '🌸', title: 'Favorite Older Sister', vibe: 'Funny, warm, protective, and impossible to fool.', greeting: 'friend... 😭 okay, what happened?' },
...
// Each character must sound like itself at every surface — not like Star.
...
function copyFor(profileKey: string, profileName: string): CharacterCopy {
  switch (profileKey) {
    ...
    // 'soft' (Star) and any unknown key both land here
    default:
      return {
        heroTitle:   'Drop a Bip 💜',
        heroSub:     "Say it how you'd text it. Star can take it.",
