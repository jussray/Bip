          ...
          {screen === 'home' && (
            <View testID="web-welcome-home">
              <View style={styles.copy}>
                ...
                <Text testID="web-welcome-subtitle" style={styles.subtitle}>A safe little world where teens and parents can stay close without losing their own space.</Text>
              </View>
              <View testID="web-welcome-hero-wrap" style={[styles.heroWrap, compact && styles.heroWrapCompact]}>
...
const styles = StyleSheet.create({
  ...
  handNote: { color: '#c8afd9', fontSize: 11, fontStyle: 'italic', textAlign: 'center', marginTop: 8, marginBottom: 10 },
