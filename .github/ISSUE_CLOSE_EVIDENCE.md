...
The gate reopens the issue when evidence is absent, stale, edited after closure, malformed, not founder-authored, or still reports unresolved risk. Merge, deployment, documentation, screenshots, or verbal approval do not automatically authorize closure.
