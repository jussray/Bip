...
export type VibeDesignTokenSet = {
  metadata: {
    ...
    character: 'suhana' | 'sy' | 'cloud' | 'night' | null;
...
export const VIBE_DESIGN_TOKENS: Record<VibeKey, VibeDesignTokenSet> = {
  raylene: createVibe(
    { vibeKey: 'suhana', displayName: "Suhana's Room", atmosphere: 'companion-day', character: 'suhana', isAtmosphereOnly: false },
  ...
  rylane: createVibe(
    { vibeKey: 'sy', displayName: 'Sy After Dark', atmosphere: 'companion-day', character: 'sy', isAtmosphereOnly: false },
